package it.uniroma3.siw.museo.autenticazione;
...
import static it.uniroma3.siw.museo.model.Admin.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                // chiunque (autenticato o no) può accedere alle pagine, login, ai css e alle immagini
                .antMatchers(HttpMethod.GET, "/**").permitAll()
                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login
                .antMatchers(HttpMethod.POST, "/login").permitAll()
                // solo gli utenti autenticati possono accedere a risorse con path /admin/**
